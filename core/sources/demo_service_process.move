module sui_intf_demo_core::demo_service_process {
    ...
    public fun foo(//<Op_1: drop>(
        ...
        binary_operator::ApplyRequest,//<Op_1>, 
        FooStep_1Context
    ) {
        let (x_1, y_1) = foo_step_0(x, y);
    ...
    public fun foo_step_1_callback<Op_1>(
        ...
        step_1_response: binary_operator::ApplyResponse<Op_1>,
        step_1_context: FooStep_1Context,
    ): (
        binary_operator::ApplyRequest,
        FooStep_2Context
    ) {
        let (step_1_request, r_1) = binary_operator::unpack_apply_respone(step_1_response);
        ...
        let step_2_request = binary_operator::new_apply_request(//_impl_witness_2, 
            y_1, 
            r_1
        );
    ...
    public fun foo_step_2_callback<Op_2>(
        ...
        step_2_response: binary_operator::ApplyResponse<Op_2>,
        step_2_context: FooStep_2Context,
    ): u64 {
        let (step_2_request, r_2) = binary_operator::unpack_apply_respone(step_2_response);
